...
class NewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create news" do
    assert_difference('News.count') do
      post news_index_url, params: { news: { content: @news.content, headline: @news.headline } }
    end
  ...
  test "should update news" do
    patch news_url(@news), params: { news: { content: @news.content, headline: @news.headline } }
