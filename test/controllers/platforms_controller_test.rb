...
class PlatformsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create platform" do
    assert_difference('Platform.count') do
      post platforms_url, params: { platform: { anime_id: @platform.anime_id, link: @platform.link, name: @platform.name } }
    end
  ...
  test "should update platform" do
    patch platform_url(@platform), params: { platform: { anime_id: @platform.anime_id, link: @platform.link, name: @platform.name } }
